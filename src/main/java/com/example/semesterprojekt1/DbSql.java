...
public class DbSql {
    ...
    DbSql() {
        ...
        stmt = null;
        try {
            String url = "jdbc:sqlite:C:/Users/nd070/OneDrive/Dokumenter/1.Semesterprojekt.db/";
    ...
    public void sletOenskeseddel(Integer id){
        try {
    ...
    /*public ArrayList <Oenske> seAlleReserveredeOensker (){
        ArrayList <Oenske> Oenskeliste=new ArrayList<>();
        if(resereveret==0)
        try{
