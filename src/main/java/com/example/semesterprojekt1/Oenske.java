...
public class Oenske {
    ...
    public int getOenskelistenr() {
        return oenskelistenr;
    }

    public void setOenskelistenr(int oenskelistenr) {
        this.oenskelistenr = oenskelistenr;
    }
    ...
    public int getReserveret() {
        return reserveret;
    }

    public void setReserveret(int reserveret) {
        this.reserveret = reserveret;
    }
